    ...
    <main className="relative h-[100dvh] min-h-screen w-full bg-black text-white flex flex-col items-center justify-center px-6 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none z-[20]">
        ...
        <motion.div 
          ...
          className="absolute left-[20%] w-10 h-10 bg-white/20 rounded-full blur-[12px] mix-blend-screen"
        />
        <motion.div 
          animate={{ y: ["120vh", "-20vh"], x: [0, -70, 40, 0], opacity: [0, 0.06, 0] }}
          transition={{ duration: 70, repeat: Infinity, ease: "linear", delay: 25 }}
          className="absolute left-[80%] w-14 h-14 bg-white/20 rounded-full blur-[16px] mix-blend-screen"
        />
