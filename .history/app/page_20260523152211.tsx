...
function CinematicDivider() {
  return (
    <div className="relative w-full h-24 md:h-40 flex items-center justify-center z-10 overflow-hidden">
      {/* Core Crisp Line */}
      <motion.div
        ...
        viewport={{ once: true }}
        className="absolute w-full max-w-5xl h-px bg-gradient-to-r from-transparent via-white/15 to-transparent origin-center"
      ...
      <motion.div
        ...
        viewport={{ once: true }}
        className="absolute w-3/4 max-w-3xl h-[3px] bg-white/20 blur-[10px] rounded-full origin-center"
...
export default function Home() {
  ...
  // Ambient subtle reactive movement based on mouse
  const ambientReactiveX = useTransform(smoothX, [0, 1920], [-40, 40]);
  const ambientReactiveY = useTransform(smoothY, [0, 1080], [-40, 40]);
  ...
  const artists = [
    { name: "BOYZAI", category: "HIP-HOP / RAP", image: "https://images.unsplash.com/photo-1493225457124-a1a2a5f5f9af?q=80&w=800&auto=format&fit=crop" },
    { name: "NOVIELLE", category: "R&B / SOUL", image: "https://images.unsplash.com/photo-1516280440502-a25e1a3bc8c3?q=80&w=800&auto=format&fit=crop" },
    { name: "G-MARTYR", category: "ALTERNATIVE", image: "https://images.unsplash.com/photo-1605806616949-1e87b487cb2a?q=80&w=800&auto=format&fit=crop" },
    { name: "VO-ICE", category: "ELECTRONIC", image: "https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?q=80&w=800&auto=format&fit=crop" },
    ...
    <main className="relative w-full bg-black text-white flex flex-col overflow-x-hidden">
      ...
      >
        <motion.div
          ...
          className="w-full h-full bg-gradient-to-b from-white/20 via-white/80 to-white/20 origin-top shadow-[0_0_15px_rgba(255,255,255,0.5)]"
      ...
      <motion.div 
        style={{ y: bgY }}
        className="fixed inset-0 w-full h-screen bg-gradient-to-b from-neutral-950 to-black pointer-events-none z-0" 
      ...
      <motion.div
        ...
        className="fixed top-[-20%] bottom-[-20%] w-[100vw] bg-gradient-to-r from-transparent via-white to-transparent blur-[140px] pointer-events-none z-0 mix-blend-screen skew-x-[-30deg]"
      ...
      <motion.div className="fixed inset-0 w-full h-screen pointer-events-none z-0" style={{ y: bgY }}>
        ...
        <motion.div style={{ x: ambientReactiveX, y: ambientReactiveY }} className="absolute inset-0 w-full h-full pointer-events-none">
          {/* Large Atmospheric Gradient Sweeps */}
          <motion.div
            animate={{ rotate: [0, 360], scale: [0.9, 1.1, 0.9], opacity: [0.03, 0.07, 0.03] }}
            transition={{ duration: 60, repeat: Infinity, ease: "linear" }}
            className="absolute top-[10%] -left-[10%] w-[80vw] h-[40vw] bg-gradient-to-r from-white/10 blur-[100px] md:blur-[150px] rounded-full mix-blend-screen origin-center"
          ...
          <motion.div
            ...
            className="absolute bottom-[10%] -right-[10%] w-[70vw] h-[50vw] bg-gradient-to-l from-white/10 blur-[120px] md:blur-[160px] rounded-full mix-blend-screen origin-center"
          className="absolute bottom-[10%] right-[-10%] w-[70vw] h-[50vw] bg-linear-to-l from-white/10 blur-[120px] md:blur-[160px] rounded-full mix-blend-screen origin-center"
          />
          {/* Fullscreen Subtle Pulse */}
          <motion.div
            animate={{ opacity: [0.01, 0.04, 0.01] }}
            transition={{ duration: 10, repeat: Infinity, ease: "easeInOut" }}
            className="absolute inset-0 bg-gradient-to-b from-white/5 mix-blend-overlay"
        ...
        >
          ...
          >
            <motion.div
              ...
              className="absolute inset-0 w-full h-[40%] bg-gradient-to-b via-white/80"
            />
          </motion.div>
      ...
      >
        ...
        <div className="w-px h-12 md:h-16 bg-white/10 relative overflow-hidden">
          <motion.div
            ...
            className="absolute inset-0 w-full h-[50%] bg-gradient-to-b from-transparent via-white/80 to-transparent"
            className="absolute inset-0 w-full h-[40%] bg-linear-to-b from-transparent via-white/80 to-transparent"
      ...
      <section className="relative w-full min-h-screen flex flex-col items-center justify-center px-6 py-24 z-10">
        ...
        >
          ...
          <motion.div
            ...
            className="mb-6"
          >
            <span className="text-[10px] md:text-xs tracking-[0.4em] text-white/50 uppercase block text-center">
              Our Talents
            </span>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10 w-full">
            {artists.map((artist, idx) => (
              <motion.div
                ...
                transition={{ duration: 1.8, ease: [0.16, 1, 0.3, 1], delay: 0.3 + idx * 0.15 }} // Cinematic stagger
                initial={{ opacity: 0, y: 30 }}
                whileInView={{ opacity: 1, y: 0 }}
                transition={{ duration: 1.5, ease: "easeOut", delay: 0.6 + idx * 0.15 }} // Staggered reveal
                viewport={{ once: true, amount: 0.2 }}
                whileHover={{ y: -5 }}
                whileHover={{ scale: 1.02, y: -5 }}
                whileTap={{ scale: 0.98 }}
                className="group relative flex flex-col justify-end w-full aspect-[4/5] md:aspect-[3/4] bg-neutral-950 border border-white/5 overflow-hidden cursor-pointer"
              ...
              >
                {/* 1. Cinematic Image Reveal & Motion */}
                <div className="absolute inset-0 w-full h-full bg-neutral-900 overflow-hidden z-0">
                  <div 
                    className="absolute inset-0 w-full h-full bg-cover bg-center opacity-40 mix-blend-luminosity transition-transform duration-[2s] ease-[cubic-bezier(0.16,1,0.3,1)] group-hover:scale-110 group-hover:opacity-70"
            ...
            <div className="absolute inset-0 bg-linear-to-br from-transparent to-white/5 opacity-0 group-hover:opacity-100 transition-opacity duration-700 ease-out z-0" />
                ...
                {/* 2. Layered Depth Gradients */}
                <div className="absolute inset-0 bg-gradient-to-t from-black via-black/40 to-transparent opacity-90 z-0" />
                <div className="absolute inset-0 bg-gradient-to-b from-black/30 via-transparent to-transparent opacity-50 z-0" />
                
                {/* 3. Hover Immersive Atmosphere (Glossy overlay) */}
                <div className="absolute inset-0 bg-white/5 opacity-0 group-hover:opacity-100 transition-opacity duration-1000 ease-out mix-blend-overlay z-0" />
                <div className="absolute -top-10 -right-10 w-40 h-40 bg-white/10 blur-[60px] rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-[1.5s] ease-out z-0" />

                {/* 4. Animated Content Reveal */}
                <div className="relative z-10 flex flex-col p-8 md:p-10 transform translate-y-4 group-hover:translate-y-0 transition-transform duration-[1.5s] ease-[cubic-bezier(0.16,1,0.3,1)]">
                  <span className="text-[9px] md:text-[10px] tracking-[0.4em] text-white/50 mb-4 transition-colors duration-700 group-hover:text-white/80 uppercase">
                    {artist.category}
                  </span>
                  
                  {/* Smooth Line Expansion */}
                  <div className="w-6 h-px bg-white/20 mb-5 transition-all duration-[1.5s] ease-[cubic-bezier(0.16,1,0.3,1)] group-hover:w-16 group-hover:bg-white/60" />
                  
                  <h3 className="text-2xl md:text-4xl font-light tracking-[0.2em] uppercase text-white/90 transition-colors duration-700 group-hover:text-white mb-1">
                    {artist.name}
                  </h3>
                </div>
                {/* Card Content */}
      ...
      <section className="relative w-full py-16 md:py-24 z-10 overflow-hidden flex items-center justify-center border-y border-white/5">
        ...
        <div className="absolute inset-y-0 left-0 w-1/4 md:w-1/6 bg-gradient-to-r from-black z-20 pointer-events-none" />
        <div className="absolute inset-y-0 right-0 w-1/4 md:w-1/6 bg-gradient-to-l from-black z-20 pointer-events-none" />
      ...
      <section className="relative w-full min-h-screen flex flex-col items-center justify-center px-6 z-10">
        ...
        >
          ...
          <motion.p
            ...
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 1.8, ease: "easeOut", delay: 0.8 }}
            className="text-sm md:text-base lg:text-lg text-white/60 font-light leading-loose tracking-wider max-w-xl mb-14"
          >
      ...
      <motion.footer
        ...
        className="relative w-full pt-32 pb-12 px-6 z-10 flex flex-col items-center bg-gradient-to-t from-black"
      >
        {/* Cinematic Glowing Top Divider */}
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-4xl h-px bg-gradient-to-r via-white/20" />
        ...
        <div className="w-full max-w-7xl flex flex-col lg:flex-row justify-between items-center lg:items-end gap-16 lg:gap-0 mb-20 text-center lg:text-left">
          ...
          >
            <span className="text-[10px] md:text-xs tracking-[0.4em] text-white/50 uppercase">
              Barbarian Village
            </span>
            <h3 className="text-sm md:text-lg font-light tracking-[0.3em] text-white uppercase">
