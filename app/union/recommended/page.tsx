...
export default function EldersHallPage() {
  return (
    <div className="relative min-h-screen w-full overflow-hidden bg-black text-zinc-400 font-sans">
      
      {/* Background Aesthetic */}
      <div className="absolute inset-0 z-0">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,_var(--tw-gradient-stops))] from-zinc-900/30 via-black to-black" />
      </div>
        ...
        <div className="w-full max-w-2xl text-center">
          ...
          <div className="mt-16 pt-8 border-t border-zinc-900 max-w-sm mx-auto">
            <p className="text-[9px] tracking-[0.2em] uppercase text-zinc-600 leading-relaxed">
              Curating external professional standards to support the Barvill ecosystem. Registry opening soon.
            </p>
          </div>
        </div>
      </div>
