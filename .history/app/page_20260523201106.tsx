...
export default function Home() {
  ...
  return (
    <main className="relative w-full bg-black text-white flex flex-col overflow-x-hidden">
      ...
      <motion.div
        animate={prefersReducedMotion ? { opacity: 0.04 } : { x: ["0%", "-1%", "0.5%", "-0.5%", "0%"], y: ["0%", "0.5%", "-1%", "1%", "0%"], opacity: [0.03, 0.05, 0.03] }}
        transition={{
      ...
      <motion.div className="fixed inset-0 w-full h-screen pointer-events-none z-0 mix-blend-screen">
        ...
        <motion.div style={{ y: prefersReducedMotion ? 0 : envY2 }} className="absolute inset-0 w-full h-full pointer-events-none">
      ...
      <motion.div className="fixed inset-0 w-full h-screen pointer-events-none z-0">
        ...
        <motion.div style={{ y: prefersReducedMotion ? 0 : glowY1 }} className="absolute inset-0 w-full h-full pointer-events-none">
          ...
          <motion.div className="absolute bottom-[-15%] right-[-15%] w-[55vw] h-[55vw] rounded-full bg-white/10 blur-[70px] md:blur-[160px] pointer-events-none z-0 mix-blend-screen will-change-transform will-change-opacity hidden md:block"
            ...
            className="absolute bottom-[-15%] right-[-15%] w-[55vw] h-[55vw] rounded-full bg-white/10 blur-[70px] md:blur-[160px] pointer-events-none z-0 mix-blend-screen will-change-transform will-change-opacity"
          />
        </motion.div>
      ...
      <section className="relative w-full min-h-screen flex flex-col items-center justify-center px-4 md:px-6 py-16 md:py-24 z-10">
        <motion.div
          variants={containerVariants}
          initial="hidden"
          whileInView="visible"
      ...
      <motion.footer
        ...
        className="relative w-full pt-24 md:pt-32 pb-12 px-4 md:px-6 z-10 flex flex-col items-center bg-linear-to-t from-black"
      >
