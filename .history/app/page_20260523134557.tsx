  ...
  return (
    <main className="relative w-full bg-black text-white flex flex-col overflow-x-hidden">
      ...
      <motion.div className="fixed inset-0 w-full h-screen pointer-events-none z-0" style={{ y: bgY }}>
        ...
        <motion.div style={{ x: ambientReactiveX, y: ambientReactiveY }} className="absolute inset-0 w-full h-full pointer-events-none">
          ...
          <motion.div
            ...
            className="absolute top-[10%] left-[-10%] w-[80vw] h-[40vw] bg-gradient-to-r from-white/10 to-transparent blur-[100px] md:blur-[150px] rounded-full mix-blend-screen origin-center"
          ...
          <motion.div
            ...
            className="absolute bottom-[10%] right-[-10%] w-[70vw] h-[50vw] bg-gradient-to-l from-white/10 to-transparent blur-[120px] md:blur-[160px] rounded-full mix-blend-screen origin-center"
          ...
          <motion.div
            ...
            className="absolute inset-0 bg-gradient-to-b from-white/5 to-transparent mix-blend-overlay"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10 w-full">
            {artists.map((artist, idx) => (
              ...
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-br from-transparent to-white/5 opacity-0 group-hover:opacity-100 transition-opacity duration-700 ease-out z-0" />
      ...
      <section className="relative w-full py-16 md:py-24 z-10 overflow-hidden flex items-center justify-center border-y border-white/5">
        ...
        <div className="absolute inset-y-0 left-0 w-1/4 md:w-1/6 bg-gradient-to-r from-black to-transparent z-20 pointer-events-none" />
        <div className="absolute inset-y-0 right-0 w-1/4 md:w-1/6 bg-gradient-to-l from-black to-transparent z-20 pointer-events-none" />
      ...
      <motion.footer
        ...
        className="relative w-full pt-32 pb-12 px-6 z-10 flex flex-col items-center bg-gradient-to-b from-transparent to-black"
