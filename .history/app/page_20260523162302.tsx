...
export default function Home() {
  ...
  return (
    <main className="relative w-full bg-black text-white flex flex-col overflow-x-hidden">
      ...
      <motion.div className="fixed inset-0 w-full h-screen pointer-events-none z-5">
      ...
      <motion.div className="fixed inset-0 w-full h-screen pointer-events-none z-20">
