...
const itemFadeUpVariants: Variants = {
  ...
  visible: {
    opacity: 1,
    y: 0,
    transition: { duration: 1.8, ease: [0.16, 1, 0.3, 1] }, // Apple-like smooth cubic-bezier
  },
};
...
export default function Home() {
  ...
  return (
    <main className="relative w-full bg-black text-white flex flex-col overflow-x-hidden">
      ...
      className="fixed top-[-20%] bottom-[-20%] w-screen bg-linear-to-r from-transparent via-white to-transparent blur-[70px] md:blur-[140px] pointer-events-none z-0 mix-blend-screen skew-x-[-30deg] will-change-transform will-change-opacity"
      ...
      <motion.div
        ...
        className="fixed top-0 left-0 w-[40vw] aspect-square max-w-2xl rounded-full bg-white/5 blur-[60px] md:blur-[120px] pointer-events-none z-0 mix-blend-screen will-change-transform"
      ...
      <motion.div style={{ x: prefersReducedMotion ? 0 : midMouseX, y: prefersReducedMotion ? 0 : midMouseY }} className="fixed inset-0 w-full h-screen pointer-events-none z-5 transform-gpu">
      ...
      <section className="relative w-full min-h-screen flex flex-col items-center justify-center px-4 md:px-6 py-24 md:py-32 z-10">
        ...
        >
          ...
          <motion.div variants={itemFadeUpVariants} className="w-full lg:w-1/2 aspect-4/5 md:aspect-square relative group overflow-hidden bg-white/5 border border-white/10 backdrop-blur-md shrink-0 cursor-pointer">
          <motion.div 
            variants={itemFadeUpVariants} 
            role="link"
            tabIndex={0}
      ...
      <motion.div style={{ x: prefersReducedMotion ? 0 : fgMouseX, y: prefersReducedMotion ? 0 : fgMouseY }} className="fixed inset-0 w-full h-screen pointer-events-none z-20 hidden md:block transform-gpu">
