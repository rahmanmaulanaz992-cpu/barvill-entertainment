    ...
    >
      <div className="max-w-7xl mx-auto px-6 md:px-8 flex items-center justify-between relative z-50">
        ...
        <button 
          ...
          className="md:hidden relative flex flex-col items-center justify-center w-8 h-8 gap-[6px] focus:outline-hidden"
          className="md:hidden relative flex flex-col items-center justify-center w-8 h-8 gap-1.5 focus:outline-hidden"
        >
          <motion.span animate={mobileMenuOpen ? { rotate: 45, y: 7 } : { rotate: 0, y: 0 }} className="w-6 h-[1px] bg-white block origin-center" transition={{ duration: 0.3 }} />
          <motion.span animate={mobileMenuOpen ? { opacity: 0 } : { opacity: 1 }} className="w-6 h-[1px] bg-white block" transition={{ duration: 0.3 }} />
          <motion.span animate={mobileMenuOpen ? { rotate: -45, y: -7 } : { rotate: 0, y: 0 }} className="w-6 h-[1px] bg-white block origin-center" transition={{ duration: 0.3 }} />
      ...
      <AnimatePresence>
        {mobileMenuOpen && (
          <motion.div
            ...
            className="fixed inset-0 w-screen h-screen bg-black/95 backdrop-blur-2xl flex flex-col items-center justify-center z-40"
          >
                  ...
                  >
                    ...
                    {isActive && (
                      <motion.span 
                        ...
                        className="absolute -bottom-3 left-1/2 -translate-x-1/2 w-1/2 h-[1px] bg-white shadow-[0_0_15px_rgba(255,255,255,0.8)]"
