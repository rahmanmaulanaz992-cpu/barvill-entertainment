...
export default function Home() {
  ...
  const artists = [
    { name: "BOYZAI", category: "CINEMATIC HIP-HOP", status: "EXCLUSIVE" },
    { name: "NOVIELLE", category: "AVANT-GARDE SOUL", status: "NEW SIGNING" },
    { name: "G-MARTYR", category: "INDUSTRIAL EXPERIMENTAL", status: "EXCLUSIVE" },
    { name: "VO-ICE", category: "AMBIENT SOUNDSCAPE", status: "EXCLUSIVE" },
    ...
    <main className="relative w-full bg-black text-white flex flex-col overflow-x-hidden">
      ...
      >
        ...
        >
          ...
          >
            “Bukan sekadar label. Sebuah universe sinematik di mana frekuensi, visi, dan kemurnian artistik dilebur menjadi warisan abadi.”
          </motion.p>
      ...
      <section className="relative w-full min-h-screen flex flex-col items-center justify-center px-4 md:px-6 z-10">
        ...
        >
          ...
          >
            Kami lahir di titik temu antara realitas dan imajinasi. Barvill adalah suaka bagi para visioner yang menolak berkompromi — sebuah ekosistem di mana penceritaan emosional dan arsitektur suara mutakhir meredefinisi masa depan hiburan.
      ...
      <section className="relative w-full min-h-screen flex flex-col items-center justify-center px-4 md:px-6 py-24 md:py-32 z-10">
        ...
        >
          ...
          <motion.div variants={itemFadeUpVariants} className="w-full lg:w-1/2 aspect-[4/5] md:aspect-square relative group overflow-hidden bg-white/5 border border-white/10 backdrop-blur-md flex-shrink-0 cursor-pointer">
          ...
          <motion.div variants={itemFadeUpVariants} className="w-full lg:w-1/2 flex flex-col items-center lg:items-start text-center lg:text-left">
            ...
            <p className="text-sm md:text-base lg:text-lg text-white/60 font-light leading-loose tracking-wider max-w-xl mb-12 cursor-default">
      ...
      <section className="relative w-full min-h-screen flex flex-col items-center justify-center px-4 md:px-6 py-24 md:py-32 z-10">
        ...
        >
          ...
          <motion.div 
            variants={itemBlurFadeUpVariants} 
            className="w-full aspect-[4/3] md:aspect-video relative group overflow-hidden bg-white/5 border border-white/10 backdrop-blur-md cursor-pointer flex-shrink-0"
          >
