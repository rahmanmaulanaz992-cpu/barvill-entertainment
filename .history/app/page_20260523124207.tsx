          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10 w-full">
            {artists.map((artist, idx) => (
              <motion.div
                ...
                whileTap={{ scale: 0.98 }}
                className="group relative flex flex-col justify-end p-10 md:p-14 min-h-[250px] md:min-h-[300px] bg-white/5 border border-white/10 backdrop-blur-md overflow-hidden cursor-pointer"
              ...
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-br from-white/0 via-white/0 to-white/5 opacity-0 group-hover:opacity-100 transition-opacity duration-700 ease-out z-0" />
