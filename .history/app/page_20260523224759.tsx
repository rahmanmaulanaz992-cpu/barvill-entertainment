...
export default function Home() {
  ...
  const artists = [
    { name: "BOYZAI", category: "HIP-HOP / ALTERNATIVE", status: "EXCLUSIVE" },
    { name: "NOVIELLE", category: "R&B / AVANT-GARDE", status: "NEW SIGNING" },
    { name: "G-MARTYR", category: "EXPERIMENTAL / ROCK", status: "EXCLUSIVE" },
    { name: "VO-ICE", category: "ELECTRONIC / AMBIENT", status: "EXCLUSIVE" },
  ];
    ...
    <main className="relative w-full bg-black text-white flex flex-col overflow-x-hidden">
      ...
      >
        ...
        >
          ...
          <motion.div variants={itemFadeUpVariants} className="mb-6">
            ...
            >
              A Modern Entertainment Company
            </motion.span>
          </motion.div>
          ...
          >
            “Lebih dari sekadar label musik. Barvill adalah ekosistem kreatif di mana suara, visi, dan identitas artistik dilebur menjadi warisan abadi.”
          </motion.p>
      ...
      <section className="relative w-full min-h-screen flex flex-col items-center justify-center px-4 md:px-6 z-10">
        ...
        >
          ...
          >
            Kami lahir dari keyakinan bahwa seniman sejati tidak berkompromi. Barbarian Village adalah suaka bagi para visioner — ruang di mana penceritaan sinematik dan eksplorasi suara tingkat tinggi bertemu untuk mendefinisikan ulang masa depan hiburan.
          </motion.p>
          </motion.div>
        </motion.div>
      </section>
      ...
      <section className="relative w-full min-h-screen flex flex-col items-center justify-center px-4 md:px-6 py-24 md:py-32 z-10">
        ...
        >
          ...
          <motion.div variants={itemFadeUpVariants} className="w-full lg:w-1/2 flex flex-col items-center lg:items-start text-center lg:text-left">
            <span className="text-[10px] md:text-xs tracking-[0.4em] text-white/50 uppercase block mb-6">Latest Transmission</span>
            ...
            <p className="text-sm md:text-base lg:text-lg text-white/60 font-light leading-loose tracking-wider max-w-xl mb-12 cursor-default">
              Sebuah lanskap suara distopia yang menggabungkan elemen industrial dengan lirik introspektif. Produksi paling ambisius dari BOYZAI hingga saat ini, meredefinisi batasan genre hip-hop alternatif.
            </p>
            <MagneticWrapper>
              <motion.button
      ...
      <section className="relative w-full min-h-screen flex flex-col items-center justify-center px-4 md:px-6 z-10">
        ...
        >
          ...
          >
            Pintu kami selalu terbuka bagi mereka yang berani mendobrak batas. Mari ciptakan sebuah anomali artistik yang melampaui ekspektasi.
          </motion.p>
