...
import { articlesData } from "@/data/mock";
...
import type { Article } from "@/components/ui/JournalCard";
...
export default function Home() {
  ...
  // --- CMS READY EDITORIAL MOCKUP ---
  const featuredJournal: Article = {
    title: "The Anatomy of Sound: G-Martyr's Industrial Awakening",
    category: "Behind The Scene",
    date: "OCT 24, 2026",
    excerpt: "Menggali lebih dalam proses kreatif di balik era 'THE AWAKENING'. Bagaimana lanskap suara mekanis diciptakan dari instrumen organik yang dihancurkan secara analog.",
  ...
  const journalArticles: Article[] = [
    {
      ...
      date: "OCT 12, 2026",
      excerpt: "Wawancara eksklusif menjelang debut album yang sangat dinantikan. Menjelajahi rentang frekuensi antara vokal manusia dan arsitektur suara sintetik.",
      image: "https://images.unsplash.com/photo-1600607686527-6fb886090705?auto=format&fit=crop&q=80"
    },
    {
      title: "Echoes Tour: A Visual Retrospective",
      category: "Visual Campaign",
      date: "SEP 28, 2026",
      excerpt: "Dokumentasi arsip visual dari tur distopia BOYZAI. Melihat kembali desain panggung monolitik dan interaksi cahaya yang meredefinisi standar konser.",
      image: "https://images.unsplash.com/photo-1540039155732-684736dd6dd6?auto=format&fit=crop&q=80"
    },
    {
      title: "The Future of Immersive Audio Experiences",
      category: "Editorial",
      date: "SEP 15, 2026",
      excerpt: "Bagaimana Barvill memelopori standar baru dalam spatial audio. Sebuah esai tentang masa depan persepsi pendengaran manusia.",
    ...
    <main className="relative w-full min-h-screen bg-black text-white flex flex-col pt-32 pb-32">
      ...
      <section className="relative w-full min-h-screen flex flex-col items-center justify-center px-4 md:px-6 py-24 md:py-32 z-10">
        ...
        >
          ...
          <FeaturedArticle article={featuredJournal} />

          {/* Journal Grid Collection */}
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-12 w-full">
            {journalArticles.map((article, idx) => (
              <JournalCard key={idx} article={article} />
            ))}
          </div>

          {/* Call to Action: View All */}
          <motion.div variants={itemFadeUpVariants} className="mt-20">
            <MagneticWrapper>
              <motion.button whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.95 }} className="group flex flex-col items-center gap-4 cursor-pointer">
                <span className="text-[10px] tracking-[0.3em] text-white/50 uppercase group-hover:text-white transition-colors duration-500">View Full Archive</span>
                <div className="w-px h-12 bg-white/20 group-hover:bg-white/60 group-hover:h-16 transition-all duration-700 ease-out" />
              </motion.button>
            </MagneticWrapper>
          </motion.div>
        </motion.div>
